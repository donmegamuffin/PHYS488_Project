...
namespace CsharpTest {
    class VectorMaths {
        ...
        public static double[] CrossProduct(double[] in_vec1, double[] in_vec2)
        {
            ...
            {
                Error.printError(Error.ErrorList.MATHS_CP_BAD_LENGTH);
                return in_vec1;
            }
        }
        ...
        public static double DotProduct(double[] in_vec1, double[] in_vec2)
        {
            ...
            for (int n = 0; n < in_vec1.Length; n++)
            {
            outval = (outval+(in_vec1[n] * in_vec2[n]));
        }
        return outval;
    }
    ...
    {
        double outval;
        outval= ((in_vec1.getX() * in_vec2.getX()) +
        (in_vec1.getY() * in_vec2.getY()) +
        (in_vec1.getZ() * in_vec2.getZ()));
        return outval;
    }
    //--------------TEMP--------------
    public static bool FuzzyEqual(double percent, double x, double y)
    {
